...
class ProfileTableHeaderView: UIView {
   ...
   var expandedPhoto: UIImageView = UIImageView()
    ...
    let closeAvatar: UIButton = {
        ...
        button.tintColor = #colorLiteral(red: 0.2864114781, green: 0.2864114781, blue: 0.2864114781, alpha: 1)
        ...
        if avatarWasTappedInSession == false {
            UIView.animateKeyframes(withDuration: 0.5, delay: 0, options: []) {
                UIView.addKeyframe(withRelativeStartTime: 0, relativeDuration: 1) { [self] in
                    ...
                    addSubviews(backgroundAvatar)
                    backgroundAvatar.addSubviews(expandedPhoto, closeAvatar)
